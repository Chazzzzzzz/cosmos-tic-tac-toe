...
type MsgCreateGame struct {
	...
	Banker  string `protobuf:"bytes,2,opt,name=banker,proto3" json:"banker,omitempty"`
...
func (m *MsgCreateGame) GetBanker() string {
	if m != nil {
		return m.Banker
	}
	return ""
...
func (m *MsgPlayMove) GetTo() uint64 {
	if m != nil {
		return m.To
	}
	return 0
...
type MsgPlayMoveResponse struct {
	Captured int32  `protobuf:"varint,1,opt,name=captured,proto3" json:"captured,omitempty"`
...
func (m *MsgPlayMoveResponse) GetCaptured() int32 {
	if m != nil {
		return m.Captured
	}
	return 0
...
func (m *MsgAcceptGame) GetGameIndex() string {
	if m != nil {
		return m.GameIndex
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MsgPlayMove)(nil), "tictactoe.tictactoe.MsgPlayMove")
	proto.RegisterType((*MsgPlayMoveResponse)(nil), "tictactoe.tictactoe.MsgPlayMoveResponse")
...
var fileDescriptor_b88d547b90797a08 = []byte{
	...
	,
}
...
func (c *msgClient) PlayMove(ctx context.Context, in *MsgPlayMove, opts ...grpc.CallOption) (*MsgPlayMoveResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tictactoe.tictactoe.Msg/PlayMove", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_PlayMove_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tictactoe.tictactoe.Msg/PlayMove",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *MsgCreateGame) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Banker) > 0 {
		i -= len(m.Banker)
		copy(dAtA[i:], m.Banker)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Banker)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
...
func (m *MsgPlayMoveResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Captured != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.Captured))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *MsgCreateGame) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Banker", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Banker = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
